...
public class PasswordCheckerTest {
	...
	public void testIsValidPasswordNoSpecialSymbol()
	{
		try{
			...
			System.out.println("Did not throw a NoSpecialCharacterException");
			assertTrue("Did not throw NoSpecialCharacterException",false);
		}
		catch(NoSpecialCharacterException e)
		{
			System.out.println("Successfully threw a NoSpecialCharacterException");
			assertTrue("Successfully threw a NoSpecialCharacterException",true);
		}
		catch(Exception e)
		{
			System.out.println("Threw some other exception besides NoSpecialCharacterException");
